  ...
  return (
    <header className="header">
      ...
      <div className="header__right">
        ...
        <button className="icon-button icon-button--wide" type="button" onClick={onLogout}>
          Выйти
        </button>

        <button className="header__user" type="button" onClick={onProfileOpen} title="Открыть профиль">
